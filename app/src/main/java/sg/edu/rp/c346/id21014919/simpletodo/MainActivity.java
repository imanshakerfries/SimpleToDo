package sg.edu.rp.c346.id21014919.simpletodo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddOrDeleteTask = findViewById(R.id.tvAddOrRemoveTask);
        ...
        spnTaskOrDelete.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch(i){
                    case 0:
                        tvAddOrDeleteTask.setText("Add a new Task");
                        btnDelete.setEnabled(false);
                        btnAdd.setEnabled(true);
                        break;

                    case 1:
                        tvAddOrDeleteTask.setText("Type the index of task in which you want to remove");
